  ...
  return (
    <footer className="container mx-auto py-3 dark:text-tertiary-100 px-3 md:px-0">
      ...
      <p>
        ...
        <a
          href={siteUrl}
          className="text-primary-900 hover:text-secondary-900 dark:text-secondary-400 dark:hover:text-secondary-900 transition-all"
        >
          {author}
        </a>
      </p>
      <div className="w-fit">
        {" "}
        <a
          href="https://github.com/Eric-Alain/theme-machine/tree/master"
          title="Theme Machine on GitHub"
          className="text-primary-900 hover:text-secondary-900 dark:text-secondary-400 dark:hover:text-secondary-900 transition-all"
        >
          <svg
